...
For a local installation, [download the latest RVP bundle](https://github.com/simnple/revanced-patches/releases/latest/download/patches-1.7.0.rvp) and choose **Local** in ReVanced Manager.
